...
# check dc
check_dc $SEEDS_IP_LIST $DC1_NODE1_INTERNAL_IP $DC1_NODE2_INTERNAL_IP $DC1_NODE3_INTERNAL_IP
export DC_IS_DC1=$?
check_dc $SEEDS_IP_LIST $DC2_NODE1_INTERNAL_IP $DC2_NODE2_INTERNAL_IP $DC2_NODE3_INTERNAL_IP
export DC_IS_DC2=$?
